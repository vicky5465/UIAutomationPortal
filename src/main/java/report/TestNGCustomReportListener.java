...
//										+ testInstanceName + ")") 
	...
	private void startSummaryRow(String label) {
		m_row += 1;
		if(m_row % 2 == 0){
		writer.print("<tr class='stripe'><td style='text-align:left;padding-right:2em'><a href='#t'"
				+ m_testIndex + "><b>" + label + "</b></a>" + "</td>");
		}else{
			writer.print("<tr><td style='text-align:left;padding-right:2em'><a href='#t'"
					+ m_testIndex + "><b>" + label + "</b></a>" + "</td>");
		}
	...
	private void tableStart(String cssclass, String id) {
		if(cssclass != null){
			writer.println("<table cellspacing='0' cellpadding='0' class=" + cssclass +  " id=" + id +">");
		}
		else{
			writer.println("<table cellspacing='0' cellpadding='0' style='padding-bottom:2em' id=" + id +">");
		}
		m_row = 0;
	}
